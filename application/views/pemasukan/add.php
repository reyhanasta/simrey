                            ...
                            <div class="row clearfix" >
                                    ...
                                    <div class="col-lg-3 col-md-3 col-xs-7 col-sm-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                 <input type="date" name="mDate" class="form-control" id="tglpemasukan" value="<?php print date("Y-m-d")?>">
                                            </div>
                                        </div>
                                    </div>
                               </div>
                               <div class="row clearfix" >
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 form-control-label">
                                        <label for="nama_pengeluaran">Jenis Pemasukan</label>
                                    </div>
                                    <div class="col-lg-3 col-md-3 col-xs-7 col-sm-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                 <input type="text" name="mJenis" class="form-control" id="jenispemasukan" value="<?= $mJenis  ?>">
                                            </div>
                                        </div>
                                    </div>
                               </div>
                               ...
                               <div class="row clearfix" >
                                    ...
                                    <div class="col-lg-3 col-md-3 col-xs-7 col-sm-8">
                                        <div class="form-group">
                                            <div class="form-line">
                                                 <input type="text" name="mNominal" class="form-control uang" id="totalpemasukan" value="<?= $mNominal ?>">
                                            </div>
                                        </div>
                                    </div>
                               </div>
