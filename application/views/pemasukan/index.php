                    ...
                    <div class="card">
                        ...
                        <div class="header">
                            ...
                            <div class="header-dropdown">
                                <a class="btn btn-primary waves-effect" href="<?= base_url('pemasukan/pemasukan_add')?>"> Tambah Data </a>
                            </div>
                        </div>
                        <div class="body">
                                ...
                                <table id="example" class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="text-align: center;" width="25%">Nama pemasukan</th>    
                                    ...
                                    <tbody>
                                        <?php $i=1; foreach($datapemasukan as $key => $row) { ?>
                                            <tr>
                                                <td style="text-align: center;"><?= $i++?></td>
                                             
                                                <td style="text-align: center;"><?= $row->mJenis?></td>
                                                <td style="text-align: center;">Rp <?= number_format($row->mNominal),",00"?></td>
                                                <td style="text-align: center;"><?= date_format(new DateTime($row->mDate),'d-M-Y');?></td>
                                                ...
                                                <td style="text-align: center;">
                                                    <ul class="header-dropdown m-r--5">
                                                        <li class="dropdown" style="list-style-type:none; margin-left:-50px">
                                                            ...
                                                            <ul class="dropdown-menu pull-right">
                                                                <li> <a href="<?= base_url()?>pemasukan/pemasukanEdit/<?= $row->mId?>" class="waves-effect">
                                                                    <i class="material-icons">settings</i>Edit</a>
                                                                </li>
                                                                 <li> <a href="<?= base_url()?>pemasukan/pemasukanDelete/<?= $row->mId?>" class="waves-effect" onclick="return confirm('Apakah yakin akna dihapus ?');">
